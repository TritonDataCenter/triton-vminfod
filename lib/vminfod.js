...
var diff = require('vmadm/lib/diff');
var mod_uuid = require('uuid');
var vasync = require('vasync');
var RingBuffer = require('bunyan').RingBuffer;
...
Vminfod.prototype.setVmobjs = function setVmobjs(callback) {
    ...
    // XXX - Testing.
    if (1) {
        console.log('\n\n Setting testing vmobjs\n\n');
        var uuid = 'e4e6a97e-cb36-4b18-95c9-8eb0d0d7787f';
        var vmobj = {
            brand: 'lx',
            customer_metadata: {
...
Vminfod.prototype.startVmWatchers =
    ...
    // start watchers for all VMs - since this function runs before
